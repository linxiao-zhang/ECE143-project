...
plt.plot(mid.listed_month, others.AVEprice,'-o', color = 'g',label = "Ford - Mid Range")
plt.plot(low.listed_month, comm.AVEprice,'-o', color = 'b',label = "Hyundai - Low Range")
plt.plot(high.listed_month, best.AVEprice,'-o', color = 'r',label = "Audi - High Range")
...
#plt.plot(np.unique(best.AVEprice), np.poly1d(np.polyfit(x, y, 1))(np.unique(x)))
plt.plot(high.year, best.AVEprice, color = 'r')
plt.plot(low.year, comm.AVEprice, color = 'g')
